...
//template <typename TYPE1, typename TYPE2, typename TYPE3> int32_t cuozblasGlobalSum (cuozblasHandle_t *oh, const int32_t m, const int32_t n, const int32_t k, const short *devASpExp, const int32_t ldas, const int32_t numsplitA, const short *devBSpExp, const int32_t ldbs, const int32_t numsplitB, TYPE3 *devCsplit, const int32_t llsc, const int32_t ldsc, TYPE1 *devC, const int32_t ldc, const TYPE1 alpha, const TYPE1 beta, const int32_t maxlevel, const int32_t sumOrder);
