...
template <typename TYPE1, typename TYPE2> int32_t ozblasSplit (ozblasHandle_t *oh, const char major, const int32_t m, const int32_t n, const TYPE1 *devInput, const int32_t ldi, TYPE1 *devOutput, const int32_t ldo, TYPE2 *devSplit, TYPE2 *devSplit2, const int32_t lds, short *devSpExp, const int32_t ldse, TYPE1 *devMax);
template <typename TYPE1, typename TYPE2> int32_t ozblasSplit3 (ozblasHandle_t *oh, const char major, const int32_t m, const int32_t n, const TYPE1 *devInput, const int32_t ldi, TYPE2 *devSplit, TYPE2 *devSplit2, const int32_t lds, short *devSpExp, const int32_t ldse, TYPE2 *devMax, TYPE2 *devTmpD1, const int32_t ldt1, TYPE2 *devTmpD2, const int32_t ldt2, TYPE2 *devTmpD3, const int32_t ldt3);
...
template <typename TYPE1, typename TYPE2> int32_t ozblasSplitSparse (ozblasHandle_t *oh, const char major, const int32_t m, const TYPE1 *devInput, const int32_t *devRowptr, TYPE1 *devOutput, TYPE2 *devSplit, TYPE2 *devSplit2, const int32_t lds, short *devSpExp, const int32_t ldse, TYPE1 *devMax);
template <typename TYPE1, typename TYPE2> int32_t ozblasGlobalSum (ozblasHandle_t *oh, const int32_t m, const int32_t n, const short *devASpExp, const int32_t ldas, const int32_t numsplitA, const short *devBSpExp, const int32_t ldbs, const int32_t numsplitB, TYPE2 *devCsplit, const int32_t llsc, const int32_t ldsc, TYPE1 *devC, const int32_t ldc, const TYPE1 alpha, const TYPE1 beta, const int32_t maxlevel, const int32_t sumOrder, const int32_t split3FlagA, const int32_t split3FlagB);

template <typename TYPE1, typename TYPE2> int32_t ozblasLocalFsum (const int32_t m, const int32_t n, const short *devASpExp, const short *devBSpExp, const TYPE2 *devCsplit, const int32_t ldcs, TYPE1 *devCtmp, const int32_t ldct, const int32_t ic, const int32_t split3FlagA, const int32_t split3FlagB);
...
template <typename TYPE1, typename TYPE2> int32_t ozblasLocalFsum3 (const int32_t m, const int32_t n, const short *devASpExp, const short *devBSpExp, const TYPE2 *devCsplit, const int32_t ldcs, TYPE1 *devCtmp, const int32_t ldct, TYPE2 *devCtmp1, const int32_t ldct1, TYPE2 *devCtmp2, const int32_t ldct2, TYPE2 *devCtmp3, const int32_t ldct3, const int32_t ic, const int32_t split3FlagA, const int32_t split3FlagB);
template <typename TYPE1, typename TYPE2> int32_t ozblasLocalFsum3simd (const int32_t m, const int32_t n, const short *devASpExp, const short *devBSpExp, const TYPE2 *devCsplit, const int32_t ldcs, TYPE1 *devCtmp, const int32_t ldct, TYPE2 *devCtmp1, const int32_t ldct1, TYPE2 *devCtmp2, const int32_t ldct2, TYPE2 *devCtmp3, const int32_t ldct3, const int32_t ic, const int32_t split3FlagA, const int32_t split3FlagB);
template <typename TYPE1, typename TYPE15, typename TYPE2> int32_t ozblasLocalFsum3 (const int32_t m, const int32_t n, const short *devASpExp, const short *devBSpExp, const TYPE15 *devCsplit, const int32_t ldcs, TYPE1 *devCtmp, const int32_t ldct, TYPE2 *devCtmp1, const int32_t ldct1, TYPE2 *devCtmp2, const int32_t ldct2, TYPE2 *devCtmp3, const int32_t ldct3, const int32_t ic, const int32_t split3FlagA, const int32_t split3FlagB);
template <typename TYPE1, typename TYPE15, typename TYPE2> int32_t ozblasLocalFsum3simd (const int32_t m, const int32_t n, const short *devASpExp, const short *devBSpExp, const TYPE15 *devCsplit, const int32_t ldcs, TYPE1 *devCtmp, const int32_t ldct, TYPE2 *devCtmp1, const int32_t ldct1, TYPE2 *devCtmp2, const int32_t ldct2, TYPE2 *devCtmp3, const int32_t ldct3, const int32_t ic, const int32_t split3FlagA, const int32_t split3FlagB);
