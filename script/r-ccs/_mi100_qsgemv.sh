...
# sum1
../../testing/testing_ozblas_qsgemv --nodisp=1 --transa=n --summode=1 --fastmode=0 --usebatchedgemm=0 --range=1:256:13 > _qsgemv_n_sum1_fast0_bgemm0_sq_s.dat 
../../testing/testing_ozblas_qsgemv --nodisp=1 --transa=t --summode=1 --fastmode=0 --usebatchedgemm=0 --range=1:256:13 > _qsgemv_t_sum1_fast0_bgemm0_sq_s.dat 

../../testing/testing_ozblas_qsgemv --nodisp=1 --transa=n --summode=1 --fastmode=0 --usebatchedgemm=0 --range=1:256:13 --m=77 > _qsgemv_n_sum1_fast0_bgemm0_m77.dat 
../../testing/testing_ozblas_qsgemv --nodisp=1 --transa=t --summode=1 --fastmode=0 --usebatchedgemm=0 --range=1:256:13 --m=77 > _qsgemv_t_sum1_fast0_bgemm0_m77.dat 

../../testing/testing_ozblas_qsgemv --nodisp=1 --transa=n --summode=1 --fastmode=0 --usebatchedgemm=0 --range=1:256:13 --n=77 > _qsgemv_n_sum1_fast0_bgemm0_n77.dat 
../../testing/testing_ozblas_qsgemv --nodisp=1 --transa=t --summode=1 --fastmode=0 --usebatchedgemm=0 --range=1:256:13 --n=77 > _qsgemv_t_sum1_fast0_bgemm0_n77.dat 



../../testing/testing_ozblas_qsgemv --nodisp=1 --transa=n --summode=1 --fastmode=0 --usebatchedgemm=1 --range=1:256:13 > _qsgemv_n_sum1_fast0_bgemm1_sq_s.dat 
../../testing/testing_ozblas_qsgemv --nodisp=1 --transa=t --summode=1 --fastmode=0 --usebatchedgemm=1 --range=1:256:13 > _qsgemv_t_sum1_fast0_bgemm1_sq_s.dat 

../../testing/testing_ozblas_qsgemv --nodisp=1 --transa=n --summode=1 --fastmode=0 --usebatchedgemm=1 --range=1:256:13 --m=77 > _qsgemv_n_sum1_fast0_bgemm1_m77.dat 
../../testing/testing_ozblas_qsgemv --nodisp=1 --transa=t --summode=1 --fastmode=0 --usebatchedgemm=1 --range=1:256:13 --m=77 > _qsgemv_t_sum1_fast0_bgemm1_m77.dat 

../../testing/testing_ozblas_qsgemv --nodisp=1 --transa=n --summode=1 --fastmode=0 --usebatchedgemm=1 --range=1:256:13 --n=77 > _qsgemv_n_sum1_fast0_bgemm1_n77.dat 
../../testing/testing_ozblas_qsgemv --nodisp=1 --transa=t --summode=1 --fastmode=0 --usebatchedgemm=1 --range=1:256:13 --n=77 > _qsgemv_t_sum1_fast0_bgemm1_n77.dat 
